...
CMAKE_ONLY_ALLOWLIST = (
    ...
    "PICO_PLATFORM",
    # The string form of PICO_PLATFORM, so CMake-only for the same reason. Bazel could
    # only offer the chip (host/rp2040/rp2350) from its constraints, not the full platform,
