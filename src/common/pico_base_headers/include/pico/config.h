...
// PICO_CONFIG: PICO_PLATFORM_STRING, Name of platform as a string; defaulted to "unknown" if the build does not set it, group=pico_base
#ifndef PICO_PLATFORM_STRING
#define PICO_PLATFORM_STRING "unknown"
#endif
