...
typedef struct {
    ...
    _REG_(SSI_SPI_CTRLR0_OFFSET)
    // SPI control
    // 0xff000000 [24-31] : XIP_CMD (0x3): SPI Command to send in XIP mode (INST_L = 8-bit) or to...
    ...
    // 0x0000f800 [11-15] : WAIT_CYCLES (0): Wait cycles between control frame transmit and data...
    ...
    _REG_(SSI_TXD_DRIVE_EDGE_OFFSET)
    // TX drive edge
