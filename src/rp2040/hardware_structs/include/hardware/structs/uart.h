...
typedef struct {
    ...
    // 0x00000010 [4]     : FEN (0): Enable FIFOs: 0 = FIFOs are disabled (character mode) that is, the...
    // 0x00000008 [3]     : STP2 (0): Two stop bits select
    // 0x00000004 [2]     : EPS (0): Even parity select
    // 0x00000002 [1]     : PEN (0): Parity enable: 0 = parity is disabled and no parity bit added to...
    ...
    // 0x00002000 [13]    : OUT2 (0): This bit is the complement of the UART Out2 (nUARTOut2) modem...
    // 0x00001000 [12]    : OUT1 (0): This bit is the complement of the UART Out1 (nUARTOut1) modem...
