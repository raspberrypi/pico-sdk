...
typedef struct {
    ...
    _REG_(DMA_CH0_WRITE_ADDR_OFFSET)
    // DMA Channel 0 Write Address pointer
    io_rw_32 write_addr;

    _REG_(DMA_CH0_TRANS_COUNT_OFFSET)
    // DMA Channel 0 Transfer Count
    io_rw_32 transfer_count;

    _REG_(DMA_CH0_CTRL_TRIG_OFFSET)
    ...
    // 0x00200000 [21]    : IRQ_QUIET (0): In QUIET mode, the channel does not generate IRQs at the end...
    // 0x001f8000 [15-20] : TREQ_SEL (0): Select a Transfer Request signal
    // 0x00007800 [11-14] : CHAIN_TO (0): When this channel completes, it will trigger the channel...
    ...
    _REG_(DMA_CH0_AL1_CTRL_OFFSET)
    // Alias for channel 0 CTRL register
    io_ro_32 al1_ctrl;

    _REG_(DMA_CH0_AL1_READ_ADDR_OFFSET)
    // Alias for channel 0 READ_ADDR register
    io_ro_32 al1_read_addr;

    _REG_(DMA_CH0_AL1_WRITE_ADDR_OFFSET)
    // Alias for channel 0 WRITE_ADDR register
    io_ro_32 al1_write_addr;

    _REG_(DMA_CH0_AL1_TRANS_COUNT_TRIG_OFFSET)
    // Alias for channel 0 TRANS_COUNT register
    io_ro_32 al1_transfer_count_trig;

    _REG_(DMA_CH0_AL2_CTRL_OFFSET)
    // Alias for channel 0 CTRL register
    io_ro_32 al2_ctrl;

    _REG_(DMA_CH0_AL2_TRANS_COUNT_OFFSET)
    // Alias for channel 0 TRANS_COUNT register
    io_ro_32 al2_transfer_count;

    _REG_(DMA_CH0_AL2_READ_ADDR_OFFSET)
    // Alias for channel 0 READ_ADDR register
    io_ro_32 al2_read_addr;

    _REG_(DMA_CH0_AL2_WRITE_ADDR_TRIG_OFFSET)
    // Alias for channel 0 WRITE_ADDR register
    io_ro_32 al2_write_addr_trig;

    _REG_(DMA_CH0_AL3_CTRL_OFFSET)
    // Alias for channel 0 CTRL register
    io_ro_32 al3_ctrl;

    _REG_(DMA_CH0_AL3_WRITE_ADDR_OFFSET)
    // Alias for channel 0 WRITE_ADDR register
    io_ro_32 al3_write_addr;

    _REG_(DMA_CH0_AL3_TRANS_COUNT_OFFSET)
    // Alias for channel 0 TRANS_COUNT register
    io_ro_32 al3_transfer_count;
...
typedef struct {
    ...
    // 0x00000200 [9]     : BSWAP (0): Locally perform a byte reverse on the sniffed data, before...
