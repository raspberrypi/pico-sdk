...
typedef struct {
    ...
    // 0x00ffffff [0-23]  : TIME (0): Indicates the number of ticks / 2 (see errata RP2040-E1) before a...
    io_rw_32 ctrl;
    ...
    // 0x000ff800 [11-19] : COUNT (0): Count down timer: the remaining number clk_tick cycles before...
