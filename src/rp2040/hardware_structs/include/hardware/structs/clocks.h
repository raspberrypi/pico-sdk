...
typedef struct {
    ...
    // 0x00100000 [20]    : NUDGE (0): An edge on this signal shifts the phase of the output by 1 cycle...
...
typedef struct {
    ...
    // 0x00010000 [16]    : CLEAR (0): For clearing the resus after the fault that triggered it has...
