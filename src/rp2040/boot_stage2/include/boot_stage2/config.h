...
// PICO_CONFIG: PICO_BOOT_STAGE2_FLASH_RELEASE_POWERDOWN, Enable/disable releasing flash device from the power-down state during boot stage 2, type=bool, default=0, group=boot_stage2
