...
// Used in the hardware structs to link to the associated hardware register
// Expands to nothing, but maks the enclosed register name parameter, `x`, navigable in IDEs
#define _REG_(x)
