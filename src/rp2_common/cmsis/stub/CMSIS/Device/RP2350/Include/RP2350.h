...
typedef struct {                                /*!< VIRTUAL Structure                                                         */
  __IM  uint32_t  DUMMY;                        /*!< Dummy register for schema compliance                                      */
