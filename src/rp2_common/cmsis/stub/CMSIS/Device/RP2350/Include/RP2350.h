...
/* ===========================================  RP2350 Specific Interrupt Numbers  =========================================== */
  ...
  PROC0_IRQ_CTI_IRQn        =  40,              /*!< 40 PROC0_IRQ_CTI                                                          */
  PROC1_IRQ_CTI_IRQn        =  41,              /*!< 41 PROC1_IRQ_CTI                                                          */
  ...
  SPARE_IRQ_0_IRQn          =  46,              /*!< 46 SPARE_IRQ_0                                                            */
  SPARE_IRQ_1_IRQn          =  47,              /*!< 47 SPARE_IRQ_1                                                            */
  SPARE_IRQ_2_IRQn          =  48,              /*!< 48 SPARE_IRQ_2                                                            */
  SPARE_IRQ_3_IRQn          =  49,              /*!< 49 SPARE_IRQ_3                                                            */
  SPARE_IRQ_4_IRQn          =  50,              /*!< 50 SPARE_IRQ_4                                                            */
  SPARE_IRQ_5_IRQn          =  51               /*!< 51 SPARE_IRQ_5                                                            */
} IRQn_Type;
...
typedef struct {                                /*!< ACCESSCTRL Structure                                                      */
  ...
  __IOM uint32_t  BUSCTRL;                      /*!< Control whether debugger, DMA, core 0 and core 1 can access
                                                     ...
                                                     or debugger, with the exception of the NSU bit, which becomes
                                                     Non-secure-Privileged-writable when the NSP bit is set.                   */
  __IOM uint32_t  ADC;                          /*!< Control whether debugger, DMA, core 0 and core 1 can access
                                                     ADC, and at what security/privilege levels they can do
                                                     so. Defaults to Secure access from any master. This register
                                                     is writable only from a Secure, Privileged processor or
                                                     debugger, with the exception of the NSU bit, which becomes
                                                     Non-secure-Privileged-writable when the NSP bit is set.                   */
  ...
  __IOM uint32_t  WATCHDOG;                     /*!< Control whether debugger, DMA, core 0 and core 1 can access
                                                     ...
                                                     the NSU bit, which becomes Non-secure-Privileged-writable
                                                     when the NSP bit is set.                                                  */
  __IOM uint32_t  PSM;                          /*!< Control whether debugger, DMA, core 0 and core 1 can access
                                                     PSM, and at what security/privilege levels they can do
                                                     so. Defaults to Secure, Privileged processor or debug access
                                                     only. This register is writable only from a Secure, Privileged
                                                     processor or debugger, with the exception of the NSU bit,
                                                     which becomes Non-secure-Privileged-writable when the NSP
...
typedef struct {                                /*!< EPPB Structure                                                            */
  ...
  __IOM uint32_t  NMI_MASK1;                    /*!< NMI mask for IRQs 32 though 51. This register is core-local,
                                                     and is reset by a processor warm reset.                                   */
...
typedef struct {                                /*!< OTP_DATA Structure                                                        */
  ...
  __IOM uint16_t  OTPBOOT_DST1;                 /*!< Bits 31:16 of the OTP boot image load destination (and entry
                                                     ...
                                                     SRAM is addresses 0x20000000 through 0x20082000) and must
                                                     be word-aligned.                                                          */
  __IOM uint16_t  MAC0;                         /*!< Bytes 0 and 1 of MAC address (ECC) The MAC is stored as bytes
                                                     in network order, so bits 7:0 of this register are the
                                                     aa in aa:bb:cc:dd:ee:ff, and bits 15:8 are the bb. Multiple
                                                     interfaces are assigned consecutive addresses from the
                                                     single MAC stored in OTP.                                                 */
  __IOM uint16_t  MAC1;                         /*!< Bytes 2 and 3 of MAC address (ECC) The MAC is stored as bytes
                                                     in network order, so bits 7:0 of this register are the
                                                     cc in aa:bb:cc:dd:ee:ff, and bits 15:8 are the dd.                        */
  __IOM uint16_t  MAC2;                         /*!< Bytes 4 and 5 of MAC address (ECC) The MAC is stored as bytes
                                                     in network order, so bits 7:0 of this register are the
                                                     ee in aa:bb:cc:dd:ee:ff, and bits 15:8 are the ff.                        */
...
typedef struct {                                /*!< OTP_DATA_RAW Structure                                                    */
  ...
  __IOM uint32_t  OTPBOOT_DST1;                 /*!< Bits 31:16 of the OTP boot image load destination (and entry
                                                     ...
                                                     SRAM is addresses 0x20000000 through 0x20082000) and must
                                                     be word-aligned.                                                          */
  __IOM uint32_t  MAC0;                         /*!< Bytes 0 and 1 of MAC address (ECC) The MAC is stored as bytes
                                                     in network order, so bits 7:0 of this register are the
                                                     aa in aa:bb:cc:dd:ee:ff, and bits 15:8 are the bb. Multiple
                                                     interfaces are assigned consecutive addresses from the
                                                     single MAC stored in OTP.                                                 */
  __IOM uint32_t  MAC1;                         /*!< Bytes 2 and 3 of MAC address (ECC) The MAC is stored as bytes
                                                     in network order, so bits 7:0 of this register are the
                                                     cc in aa:bb:cc:dd:ee:ff, and bits 15:8 are the dd.                        */
  __IOM uint32_t  MAC2;                         /*!< Bytes 4 and 5 of MAC address (ECC) The MAC is stored as bytes
                                                     in network order, so bits 7:0 of this register are the
                                                     ee in aa:bb:cc:dd:ee:ff, and bits 15:8 are the ff.                        */
...
typedef struct {                                /*!< POWMAN Structure                                                          */
  ...
  __IOM uint32_t  BOOTDIS;                      /*!< Tell the bootrom to ignore the BOOT0..3 registers following
                                                     the next PSM reset (e.g. the next core power down/up).
...
typedef struct {                                /*!< SYSINFO Structure                                                         */
  ...
  __IOM uint32_t  PACKAGE_SEL;                  /*!< Package selection indicator, 0 = QFN80, 1 = QFN60                         */
...
typedef struct {                                /*!< TRNG Structure                                                            */
  ...
  __IOM uint32_t  AUTOCORR_STATISTIC;           /*!< Statistics about autocorrelation test activations.                        */
...
/**
  * @brief DPRAM layout for USB device. (USB_DEVICE_DPRAM)
  */

typedef struct {                                /*!< USB_DEVICE_DPRAM Structure                                                */
  ...
  __IOM uint32_t  EP15_OUT_BUFFER_CONTROL;      /*!< Buffer control for both buffers of an endpoint. Fields ending
                                                     ...
                                                     buffer 0. Buffer 1 controls are only valid if the endpoint
                                                     is in double buffered mode.                                               */
} USB_DEVICE_DPRAM_Type;                        /*!< Size = 256 (0x100)                                                        */
...
/**
  * @brief VIRTUAL (VIRTUAL)
  */

typedef struct {                                /*!< VIRTUAL Structure                                                         */
  __IOM uint32_t  DUMMY;                        /*!< Dummy register for schema compliance                                      */
} VIRTUAL_Type;                                 /*!< Size = 4 (0x4)                                                            */
...
#define USB_DEVICE_DPRAM_BASE       0x50100000UL
...
#define VIRTUAL_BASE                0x00000000UL
...
#define USB_DEVICE_DPRAM            ((USB_DEVICE_DPRAM_Type*)  USB_DEVICE_DPRAM_BASE)
...
#define VIRTUAL                     ((VIRTUAL_Type*)           VIRTUAL_BASE)
